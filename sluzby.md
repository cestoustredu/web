...
Mycoterapie (či poradenství o vhodnosti jiných produktů) zahrnuje rozhovor 30 - 60 minut. Komplexní konzultace většinou trvá 2 - 2,5 hodiny.

**Doporučení před biorezonanční analýzou:**

- Prosím, nepijte hodinu předem stimulační nápoje jako je káva, černý či zelený čaj, alkohol, energetické drinky, colu.
- Nejezte těžké jídlo.
- Pokud to není nutné, neberte léky na bolest.
- Denní léky od lékaře určitě nevynechávejte.

Prvním rozhovorem zjistím, co vás trápí a poté provádím screeningovou energeticko-informační analýzu (NLS) a harmonizaci na přístroji OBERON, kde zjišťuji mimo jiné komplexní energetické zatížení organismu (plísně, bakterie, paraziti atd.), emoční stres, stav jednotlivých energetických drah (pentagram pěti prvků), energetické blokády atd.
...
A dále, v případě potřeby, zanalyzuji variabilitu srdeční frekvence (HRV) na přístroji HEART VISION. Analýza je mimo jiné oknem do regulace autonomního nervového systému a informuje nás především o funkci jeho dvou hlavních větví sympatiku a parasympatiku, jejich dynamické rovnováze a vzájemném působení stresové složky sympatiku a aktivity klidového módu v podobě parasympatiku. Tím zjistíme celkový index napětí těla (stres index), psycho-emocionální stav, informuje nás o spotřebě energie organismu a díky zpětné vazbě i o využití samoregulace organismu. Variabilita srdečního rytmu nám jednoduše prozradí váš aktuální fyzický i psychický stav dle reaktivity autonomního nervového systému.
...
- Prevence a podpora celkové vitality
- Podpora léčby chronických onemocnění
- Alergické reakce a nesnášenlivosti
- Bolesti pohybového aparátu

### Důležité upozornění

Nabízené služby nejsou náhradou lékařské péče. V případě akutních zdravotních potíží vždy vyhledejte lékaře. Moje služby jsou doplňkovou metodou podpory zdraví a well-beingu.

{: .text-center}
[Ceník služeb]({{ '/cenik/' | relative_url }}){: .btn .btn-primary }
[Objednat se]({{ '/kontakt/' | relative_url }}){: .btn .btn-secondary }
